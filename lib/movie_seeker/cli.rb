...
class MovieSeeker::CLI
	...
	def stored_list_for_now
	   MovieSeeker::In_theaters.create_in_theaters(MovieSeeker::Scraper.scrape_in_theaters_page)
 	end

	def stored_coming_soon
		MovieSeeker::Coming_soon.create_coming_soon(MovieSeeker::Scraper.scrape_coming_soon_page)
	end
